...
Skills contain executable guidance. Review their instructions, references, scripts, assets, external links, and adapters before use.

Legal research workflows do not replace licensed counsel. Verify the applicable jurisdiction and the current operative texts for each matter.
